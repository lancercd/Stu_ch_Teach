...
public class GuideAdviserDao {
    ...
    /**
     * 根据搜索内容，以及学期，查找所有指导教师
     * @param semester
     * @param searchValue
     * @return
     */
    public List<GuideAdviser> getGuideAdvisers(Semester semester, String searchValue){
        ...
        String sql = "select guide_adviser_id, tb_jk2_guide_adviser.semester_id, tb_jk2_guide_adviser.stu_id,\n" +
                ...
                "and tb_jk2_guide_adviser.guide_adviser_affirm = 1 " +
                "and teacher_name like ?;";

        List<GuideAdviser> guideAdvisers = template.query(sql,
                new BeanPropertyRowMapper<GuideAdviser>(GuideAdviser.class),
                semester.getSemester_id(), searchValue);
